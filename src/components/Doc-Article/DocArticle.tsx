...
import DetailExecution from "./DetailExecution"
import DetailExecutionFaq from "./DetailExecutionFaq"
import VerifyingResult from "./VerifyingResult"

const DocArticle = () => {
  return (
    <div className="max-w-[860px] mx-auto px-6 pt-8 md:pt-28">
