...
describe("VendorSelector", () => {
  ...
  beforeEach(() => {
    render(
      <VendorSelector
        selectedVendorIdentifiers={mockSelectedVendorIdentifiers}
  ...
  test("calls handleChange function when a checkbox is toggled", () => {
    ...
    fireEvent.click(li)
    expect(mockSetSelectedVendorIdentifiers).toHaveBeenCalledTimes(
      2 /* 1 by the useEffec() and 1 by the onclick() */,
    )
  })
})
