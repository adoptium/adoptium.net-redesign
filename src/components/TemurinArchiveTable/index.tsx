...
const TemurinArchiveTable = ({ results, updatePage }) => {
  ...
  return (
    <div id="archive-list">
      <table
        id="archive-table"
        className="table table-borderless table-condensed archive-container"
                    ...
                    >
                      <div>
                        <a href={release.release_link} className="link-light">
                          <h2 className="pt-5" style={{ fontSize: "1.5rem" }}>
                        ...
                        <h4 className="pt-3 pb-3" style={{ fontSize: ".8rem" }}>
                          {localeDate(release.timestamp, language)}
                        </h4>
                        {release.source_url && (
                          <p>
                            <a href={release.source_url} className="link-light">
                              <FaDownload /> <Trans>Source Code Archive</Trans>
                            </a>
                          </p>
                        )}
