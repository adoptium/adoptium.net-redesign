  ...
  return (
    <div>
      <div className="my-2">
        ...
        <div className="my-6 bg-[#2B194F] rounded-2xl p-4 flex items-center gap-5">
          <div className="flex items-center gap-2 cursor-pointer customradiobutton">
            <input
              className="cursor-pointer border-[#3E3355] border rounded-[4px] bg-transparent w-5 h-5"
              id="sign up"
              ...
              required
            />
            <label className="tab-button-text cursor-pointer" htmlFor="sign up">
              {" "}
        ...
        <div>
          <h3 className="text-[12px] font-bold text-lightgrey">
            ...
            occasionally contact you about our relevant products and services.
            You may unsubscribe at any time by following the instructions which
            are included in every communication we send as a result of you
            having provided this information. For more information regarding our
