  ...
  return (
    <div className="alert text-white alert-dismissible fade show mb-0 text-center" style={{ backgroundColor: '#ff1464' }} role="alert">
     <strong className='p-1'>2nd of August 2022:</strong>
       We are going to replace the 8u342 binaries with a 8u345 release to fix <a className='alert-link p-1 text-white' href="https://bugs.openjdk.org/browse/JDK-8290832">JDK-8290832</a>. <br/>
