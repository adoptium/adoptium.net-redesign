      ...
      <div className="pt-16   pb-8 md:pb-16 max-w-[1048px] flex-col lg:flex-row mx-auto w-full px-8 lg:px-2 xl:px-0 flex justify-center gap-16 items-center">
        <div className=" w-full lg:w-[55%] text-center lg:text-left">
          ...
          <div>
            ...
            <div className="text-grey justify-start inline-flex pt-4"><div className="pt-1"><RedIcon /></div><div className="pl-4">Write a blog post, article or <a href="https://www.meetup.com/adoptium-summit-series/" className="text-pink" rel="noopener noreferrer" target="_blank">conference talk</a> about the story of your migration to or use of Temurin is helping your company.</div></div>
            <div className="text-grey justify-start inline-flex pt-4"><div className="pt-1"><RedIcon /></div><div className="pl-4">Participate in a <a href="https://forms.gle/WyZeYW7SNXpVYpKHA" className="text-pink" rel="noopener noreferrer" target="_blank">case study</a>, if you have a compelling use case that showcases one or more of the benefits of Temurin, such as a more secure supply chain or use of our early-access build to prepare your company to move to best-in-class newer versions of Java(TM).</div></div>
