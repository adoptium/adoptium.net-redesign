    ...
    <div className="max-w-[1264px] mx-auto px-6 py-10">
      <div className="flex justify-center lg:justify-between flex-wrap  items-start gap-5 ">
        <div className="flex flex-col max-w-[900px] gap-3">
          <h3 className="text-[36px] md:text-[48px] font-hanken text-center lg:text-start leading-[122.222%] md:leading-[116.667%] font-semibold text-white my-0 ">
            Previous Release Notes
          </h3>{" "}
          <p className="text-[20px] text-[#C4BFCE] leading-[150%] font-normal text-center lg:text-start">
      ...
      <div className="flex gap-10 mt-[40px]">
        <div className="bg-[#0E002A] rounded-[24px] p-6 md:p-8 w-full lg:w-[60%] flex flex-col gap-6">
          <ReleaseCardWarrper
        ...
        <div className=" hidden w-[30%] lg:flex flex-col h-[1640px] scroll-container overflow-auto">
          {datarepeate.map((data, index) => (
            <div key={index} className="flex flex-col mt-3">
              <h3
                className={`text-[16px] font-bold leading-[150%] ${index === 0 ? "text-primary" : ""}`}
              >
                {data.date}
              </h3>
              <p className="text-[16px] text-center font-normal !mb-0 leading-[150%] pt-1">
                {data.name}
              </p>
              <p className="text-[16px] text-center font-normal !mb-0 leading-[150%] pt-1 ">
                {data.sendername}
