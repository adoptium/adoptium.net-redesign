...
const HeroSection = () => {
  return (
    <div>
      <div className=" sm:bg-contain bg-temurin-hero bg-center bg-no-repeat relative -z-10">
        <div className="relative isolate">
          ...
          <div className="max-w-[1264px] mx-auto flex justify-center items-center">
            <div className="mx-auto max-w-[832px] w-full h-[520px] sm:h-[720px] px-8 lg:px-0 flex items-center">
