...
import { AdobeIcon2, AdobeIcon3 } from "../Common/Icon"
          ...
          >
            <div className="flex flex-col lg:flex-row justify-between gap-4 lg:items-center">
              ...
              <div className="lg:flex  items-center gap-6">
                <p className="text-base text-[#C4BFCE] leading-[24px] mb-0  hidden lg:block">
                  {data.date}
                </p>
                <p className="text-base text-[#C4BFCE] leading-[24px] mb-0 hidden lg:block">
                  {data.date}
                ...
                <p className="text-base text-[#C4BFCE] leading-[24px] hidden lg:block mb-0">
                  {data.product}
                </p>
                <p className="text-base text-[#C4BFCE] leading-[24px] mb-0 hidden lg:block">
                  {data.modal}
            ...
            <div className="flex items-end justify-between mt-4 md:mt-0 gap-5">
              <h3 className="text-base font-semibold leading-[24px] border-b-2 border-white pb-3">
                {data.check}
              </h3>
              <Link
                to={""}
