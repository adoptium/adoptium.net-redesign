...
const PageHeader = ({
  ...
  return (
    <div className="pt-60 pb-32 md:pt-48 md:pb-32 overflow-hidden">
      ...
      <div className="mx-auto max-w-[1048px] w-full px-6 lg:px-0 flex flex-col items-center justify-center">
        <div className="self-stretch h-52 flex-col justify-center items-center gap-6 flex">
          ...
          <div className="self-stretch text-center text-grey text-grey-300 text-[20px] font-normal pt-5  leading-7">
            {description}
          </div>
        </div>
      </div>
