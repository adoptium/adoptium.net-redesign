    ...
    <section className="py-5 text-center container">
      <div className="row py-lg-5">
        <div className="col-lg-8 col-md-8 mx-auto">
          ...
          <p className="pt-3">
            <Trans shouldUnescape i18nKey="marketplace.marketplaceDescription">
              Java&trade; is the world's leading programming language and
              platform. The Adoptium Marketplace promotes high-quality, TCK
              certified and AQAvit verified runtimes for use across the Java
              ecosystem.
            </Trans>
          </p>
            ...
            <div className="col-12 col-sm-6 col-md-8 ">
              <p className="text-start">
                <Trans
                  ...
                  components={{
                    aqavitLink: (
                      <LinkText href="https://github.com/Adoptium/aqa-tests" />
                    ),
                    blogPostLink: (
                      <LinkText href="https://blog.adoptopenjdk.net/2017/12/testing-java-help-count-ways" />
                    ),
                  }}
                />
              </p>
      ...
      <DownloadDropdowns
        updaterAction={getAllPkgsForVersion}
        marketplace
        Table={DownloadTable}
      />
      <ChecksumModal />
