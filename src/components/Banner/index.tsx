  ...
  // Comment Out The Above Line ( return null ; ) and uncomment the below
   ...
   return (
     <div className="alert text-white alert-dismissible fade show mb-0 text-center" style={{ backgroundColor: '#ff1464' }} role="alert">
       <strong className='p-1'>17th September 2024:</strong>
          We are creating the September 2024 PSU binaries for Eclipse Temurin 23<br/>
          You can track progress <a className='alert-link p-1 text-white' href="https://github.com/adoptium/temurin/issues/57">by platform</a>.
