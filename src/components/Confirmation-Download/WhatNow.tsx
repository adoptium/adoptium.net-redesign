...
const WhatNow = () => {
  return (
    <>
      <section className="pt-14 pb-12 md:pb-28 md:pt-32 max-w-[1048px] w-full mx-auto flex flex-col  lg:flex-row justify-center items-center lg:justify-between xl:px-0 px-6 ">
        ...
        <div className="lg:max-w-[560px] w-full  ">
          ...
          <div>
            <Link to={""}>
              <button className="bg-transparent mt-6 border-2 border-pink-500/0 text-white text-base leading-6 font-normal w-[180px] h-[48px] rounded-2xl gradient-border ">
                Installation Guide
              </button>
            </Link>
          </div>
