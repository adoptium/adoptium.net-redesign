          ...
          <div className="w-full lg:w-4/5 mx-auto py-8">
            <div className="flex flex-wrap justify-center">
              <DocumentationCard
                ...
                links={[
                  {
                    name: t("docs.install.temurin", "Install Temurin"),
                    link: "/installation",
                  },
                  {
                    name: t("docs.download.temurin", "Download Temurin"),
                    link: "/temurin/releases",
                  },
                  {
                    name: t("docs.container.images", "Container Images"),
                    link: "https://hub.docker.com/_/eclipse-temurin",
                  },
                  {
                    name: t("docs.release.archive", "Release Archive"),
              ...
              <DocumentationCard
                ...
                links={[
                  {
                    name: t("docs.support.guide", "Support Guide"),
                    link: "/support",
                  },
                  {
                    name: t("docs.commercial.support", "Commercial Support"),
                    link: "/temurin/commercial-support",
                  },
                  {
                    name: t("docs.migration.guide", "Migration Guide"),
                    link: "/docs/migration",
                  },
                  {
                    name: t("docs.supported.platforms", "Supported Platforms"),
                    link: "/supported-platforms",
                  },
                  {
                    name: t("docs.submit.an.issue", "Submit an Issue"),
              ...
              <DocumentationCard
                ...
                links={[
                  {
                    name: t("docs.how.to.contribute", "How To Contribute"),
                    link: "/contributing",
                  },
                  {
                    name: t("docs.first.time.support", "First Timer Support"),
                  ...
                  {
                    name: t("docs.code.of.conduct", "Code of Conduct"),
              ...
              <DocumentationCard
                ...
                links={[
                  ...
                  {
                    name: t("docs.sponsor.the.project", "Sponsor the Project"),
              ...
              <DocumentationCard
                ...
                links={[
                  {
                    name: t("docs.adoptium.on.github", "Adoptium on GitHub"),
                    link: "https://github.com/adoptium",
                  },
                  {
                    name: t("docs.repository.overview", "Repository Overview"),
                    link: "https://github.com/adoptium/adoptium/blob/main/README.md",
                  },
                  {
                    name: t("docs.build.scripts", "Build Scripts"),
                    link: "https://github.com/adoptium/temurin-build",
                  },
                  {
                    name: t("docs.installer.code", "Installer Code"),
              ...
              <DocumentationCard
                ...
                links={[
                  ...
                  {
                    name: t("docs.adoptium.api", "Adoptium API"),
              ...
              <DocumentationCard
                ...
                links={[
                  {
                    name: t("docs.brand.guidelines", "Brand Guidelines"),
                  ...
                  {
                    name: t("docs.marketing.criteria", "Marketing Criteria"),
