  ...
  return (
    <div>
      <ShellBox>
        ...
        <span className="install__text__command">winget install </span>EclipseAdoptium.Temurin.17
      </ShellBox>
      <br />
      <ShellBox>
        ...
        <br />
        <span className="install__text__no-select">$</span>
        <span className="install__text__command">winget install </span>EclipseAdoptium.Temurin.11
      </ShellBox>
      <br />
      <ShellBox>
        ...
        <br />
        <span className="install__text__no-select">$</span>
        <span className="install__text__command">winget upgrade </span>EclipseAdoptium.Temurin.17
      </ShellBox>
      <br />
      <ShellBox>
