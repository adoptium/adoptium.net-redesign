        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="pt-24 pb-20 md:pt-32 md:pb-28 flex flex-col items-center">
            <div className="absolute sm:static sm:z-auto top-[80px] z-[-1] left-[50%] translate-x-[-50%] sm:translate-x-0">
              <HeroBgImg className="sm:w-full sm:max-w-3xl" alt="background-image" />
            </div>
            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="mt-8 text-lg sm:text-xl md:text-2xl text-white/90 leading-relaxed font-medium max-w-3xl mx-auto">
                The quality and runtime branding evaluation project for Java SE runtimes and
                associated technology. We ensure your Java runtime meets exceptional quality 
                standards for performance, security, and reliability in production environments.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/20 hover:border-pink-500/50 hover:bg-white/10 transform hover:-translate-y-2 transition-all duration-300 shadow-xl shadow-purple-500/10 hover:shadow-purple-500/20">
              ...
              <h2 className="text-2xl font-bold mb-4 text-white">Quality Assurance</h2>
            ...
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/20 hover:border-pink-500/50 hover:bg-white/10 transform hover:-translate-y-2 transition-all duration-300 shadow-xl shadow-purple-500/10 hover:shadow-purple-500/20">
              ...
              <h2 className="text-2xl font-bold mb-4 text-white">Verified Runtime</h2>
              <p className="text-gray-300 leading-relaxed">
            ...
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/20 hover:border-pink-500/50 hover:bg-white/10 transform hover:-translate-y-2 transition-all duration-300 shadow-xl shadow-purple-500/10 hover:shadow-purple-500/20">
              ...
              <h2 className="text-2xl font-bold mb-4 text-white">Application Testing</h2>
              <p className="text-gray-300 leading-relaxed">
          ...
          <div className="flex flex-col space-y-24">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="order-2 md:order-1">
                ...
                <h2 className="text-3xl md:text-4xl font-bold mt-4 mb-6 text-white">The AQAvit Name</h2>
                <p className="text-gray-300 text-lg leading-relaxed mb-6">
                  The AQAvit project gets its name from <span className="font-semibold text-purple-200">Adoptium Quality Assurance</span> 'AQA' and 'vit' for vitality and speed. 
                </p>
              ...
              <div className="order-1 md:order-2 bg-gradient-to-br from-purple-600/40 to-pink-600/40 rounded-2xl p-6 shadow-xl backdrop-blur-sm border border-white/20 hover:border-white/30 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-2xl hover:shadow-purple-500/20 group">
                <div className="bg-white/15 backdrop-blur-md rounded-xl p-6 transform rotate-1 shadow-lg border border-white/10 group-hover:border-white/20 transition-all duration-300">
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      <div className="text-sm text-gray-400">Project Name Origin</div>
                      <div className="text-lg font-bold text-purple-300">AQA + vit</div>
                    </div>
                  </div>
                  <div className="flex space-x-2 mb-2">
                    <div className="bg-purple-800/50 backdrop-blur-sm rounded-full px-3 py-1 text-sm text-purple-200 border border-purple-500/50 shadow-sm">Adoptium</div>
                    <div className="bg-purple-800/50 backdrop-blur-sm rounded-full px-3 py-1 text-sm text-purple-200 border border-purple-500/50 shadow-sm">Quality Assurance</div>
                    <div className="bg-pink-800/50 backdrop-blur-sm rounded-full px-3 py-1 text-sm text-pink-200 border border-pink-500/50 shadow-sm">Vitality</div>
                  </div>
              ...
              <div className="order-2 md:order-1 bg-gradient-to-br from-purple-600/40 to-pink-600/40 rounded-2xl p-6 shadow-xl backdrop-blur-sm border border-white/20 hover:border-white/30 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-2xl hover:shadow-purple-500/20 group">
                <div className="bg-white/15 backdrop-blur-md rounded-xl p-6 transform -rotate-1 shadow-lg border border-white/10 group-hover:border-white/20 transition-all duration-300">
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      <div className="text-sm text-gray-400">Repository Hub</div>
                      <div className="text-lg font-bold text-purple-300">aqa-tests</div>
                    </div>
                  </div>
                  <div className="flex flex-wrap gap-2 mb-3">
                    <div className="bg-blue-800/50 backdrop-blur-sm rounded-full px-3 py-1 text-sm text-blue-200 border border-blue-500/50 shadow-sm">Test Definitions</div>
                    <div className="bg-green-800/50 backdrop-blur-sm rounded-full px-3 py-1 text-sm text-green-200 border border-green-500/50 shadow-sm">Documentation</div>
                    <div className="bg-amber-800/50 backdrop-blur-sm rounded-full px-3 py-1 text-sm text-amber-200 border border-amber-500/50 shadow-sm">Test Suite Base</div>
                  </div>
                  ...
                  >
                    View on GitHub <FaArrowRight className="ml-2 text-sm group-hover:translate-x-1 transition-transform duration-200" />
                  </a>
                </div>
              </div>
              <div className="order-1 md:order-2">
                <span className="bg-purple-900/50 text-purple-200 text-xs font-semibold px-3 py-1 rounded-full border border-purple-500/50 shadow-sm">DEVELOPMENT</span>
                <h2 className="text-3xl md:text-4xl font-bold mt-4 mb-6 text-white">AQAvit Project Central</h2>
                <p className="text-gray-300 text-lg leading-relaxed mb-6">
                  AQAvit is comprised of many repositories listed in the Developer Resources 
                  section of the Eclipse Foundation AQAvit project page. The central repository is <span className="font-semibold text-purple-200">aqa-tests</span>, 
                  which houses the project's test definition files, documentation, and serves as the base for running the AQAvit test suite.
                </p>
                <p className="text-gray-300 text-lg leading-relaxed mb-6">
                  To participate in the project, join the Adoptium Slack workspace and ask questions 
                  in the <span className="font-semibold text-purple-200">#testing-aqavit</span> channel.
                </p>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mt-24">
              <div>
                <span className="bg-pink-900/50 text-pink-200 text-xs font-semibold px-3 py-1 rounded-full border border-pink-500/50 shadow-sm">CERTIFICATION</span>
                ...
                <p className="text-gray-300 text-lg leading-relaxed mb-6">
                  By running these tests, you can ensure your Java runtime meets the high-quality 
                ...
                <div className="relative bg-white/15 backdrop-blur-md rounded-2xl p-8 shadow-xl border border-white/20 hover:border-white/30 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-2xl hover:shadow-pink-500/20">
                  <div className="space-y-6 relative z-10">
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        <h3 className="text-lg font-medium text-white">Functional Testing</h3>
                        <p className="mt-2 text-base text-gray-300">Validates core API functionality and behavior across platforms</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        <h3 className="text-lg font-medium text-white">Performance Testing</h3>
                        <p className="mt-2 text-base text-gray-300">Ensures runtime meets performance expectations under various workloads</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="mt-2 text-base text-gray-300">Tests security features and protections against common vulnerabilities</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        <h3 className="text-lg font-medium text-white">Compatibility Verification</h3>
                        <p className="mt-2 text-base text-gray-300">Confirms compatibility with popular frameworks and applications</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="relative bg-gradient-to-br from-[#1a0b38]/90 to-[#2b1a4f]/90 backdrop-blur-lg rounded-3xl border border-white/10 p-12 shadow-2xl overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                  <div className="max-w-2xl">
                    <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Start ensuring your Java runtime quality today</h2>
