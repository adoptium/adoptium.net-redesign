        ...
        <div className="col-lg-8 col-md-8 mx-auto">
          ...
          <div className="btn-group-vertical">
            <a
              target="_blank"
              rel="noreferrer"
              href="https://www.eclipse.org/org/workinggroups/sponsorship/working-group-sponsorship-agreement.pdf"
            ...
            >
              <SiGithubsponsors
                aria-label="GitHub Sponsors Logo"
                color="#bf3989"
              />{" "}
...
export const Head = () => <Seo title="Adoptium Project Sponsors" />
